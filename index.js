...
client.login('NTYwNTE3ODk1MTg5MTY4MTI4.D31Hrg.J1zFa4-4e5U78gOE9Whxd71xVS4');
...
client.on('message',message=>{
    if(message.content === ".help"){
        ...
        message.channel.sendMessage('voila')
...
client.on('message',message=>{
  if(message.content === ".lien"){
    message.channel.sendMessage('https://discordapp.com/oauth2/authorize?client_id=560517895189168128&scope=bot&permissions=8')
  }
}
)
